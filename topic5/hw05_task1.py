...
# В цбому завданні не потрібно було створювати графіки, але я вирішив тут попрактикуватися (використовував допоміжні ресурси для генерації коду, оскільки ще не дуже розбираюсь у matplotlib.pyplot)
